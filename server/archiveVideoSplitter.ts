...
const DEFAULT_SCENE_THRESHOLD = 0.05; // only hard scene changes, ignores brightness flicker
const DEFAULT_SCDET_THRESHOLD = 1.0; // only hard cuts, ignores film grain / light flicker
