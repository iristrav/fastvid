...
### B-Roll System
- [ ] Add dedicated B-roll search: per scene fetch 2-3 short (2-4s) cutaway clips from Pexels/SerpAPI
- [ ] B-roll clips inserted between main clips at natural pause points (every 8-12s of narration)
- [ ] B-roll queries generated by LLM: specific visual metaphors, close-ups, abstract concepts

### Highlight Word Overlays (Kinetic Typography)
- [ ] LLM extracts 2-3 "power words" per scene (numbers, names, key facts)
- [ ] Animated text callout: word appears in large bold font mid-screen for 1.5s with slide-in animation
- [ ] Style: white text, colored accent (yellow/cyan), subtle drop shadow, ALL CAPS
- [ ] Timed to voiceover: word appears exactly when spoken

### Cinematic Effects
- [ ] Zoom punch: 0.3s fast zoom-in (scale 1.0→1.08) on scene transition or key moment
- [ ] Film grain/speckles overlay: subtle noise texture (opacity 8-12%) on all clips
- [ ] Lens flare: occasional subtle white flash (0.1s) on hard cuts
- [ ] Push transition: horizontal slide between scenes (replaces hard cut for 30% of transitions)
- [ ] Color grade presets: "documentary" (cool desaturated), "drama" (warm contrast), "tech" (teal/orange)

### Sound Effects Library
- [ ] Camera shutter click: on photo/image clips (SerpAPI stills)
- [ ] Whoosh: on scene transitions
- [ ] Impact/thud: on chapter cards and key stat reveals
- [ ] Subtle ambient: room tone under voiceover (low-pass filtered)
- [ ] All SFX generated via FFmpeg sine/noise synthesis (no external files needed)
- [ ] SFX mixed at -18dB under voiceover
